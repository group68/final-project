...
?>
            <div class="col span-1-of-3 box card card-5 shadow-box">
                <a style="color: white; font-size: 24px"
                    href="<?php echo "/products/view/{$bs['Product']['product_id']}" ?>">
                    <div>
                        <p><?php echo $bs['Product']['NAME'] ?></p>
                        <img class="bestseller-img" src="<?php echo $bs['Product']['image_url'] ?>"
                            alt="<?php echo $bs['Product']['NAME'] ?>" />
    ...
    ?>
            <div class="col span-1-of-3 box card card-6 shadow-box">
                <a style="color: black; font-size: 24px;"
                    href="<?php echo "/products/view/{$his['Product']['product_id']}" ?>">
                    <div>
                        <p><?php echo $his['Product']['NAME'] ?></p>
                        <img class="bestseller-img" src="<?php echo $his['Product']['image_url'] ?>"
                            alt="<?php echo $his['Product']['NAME'] ?>" />
